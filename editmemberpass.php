...
<html>
<head><title>Change Members Password Here</title></head>
<body link='white'>
...
<h1 style='color:white' align='center'>Change Members Password Here!</h1>
</td>
</tr>
...
<html>
<body>
<form method='post' action='editmemberpass.php'>
...
if(mysql_query($query)){
	echo "<script>window.open('memberview.php?Upd=Your Username or Password has been Updated!','_self')</script>";
	}
