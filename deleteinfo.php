...
$d = @$_GET['d'];
$query = ("DELETE FROM admission_form WHERE id='$d'") or die(mysql_error());
if(mysql_query($query)){
	echo "<script>window.open('viewstudentinfo.php?del=Selected Record has been Deleted!','_self')</script>";
	exit(0);
	}
